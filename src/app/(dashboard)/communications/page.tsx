  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-black">
        <div className="text-lg text-zinc-600 dark:text-zinc-400">Loading communications...</div>
      </div>
    );
  }
          ...
          <div className="space-y-6">
                  ...
                  <div className="border-t border-zinc-200 dark:border-zinc-800 pt-4">
                    ...
                    <div className="space-y-2">
                      {ticket.comments.map((comment) => (
                        <div key={comment.id} className="bg-zinc-50 dark:bg-zinc-800 rounded p-3 text-sm">
            ...
            {data.tickets.length === 0 && (
              <motion.div
                ...
                className="text-center py-12"
              >
                <p className="text-zinc-600 dark:text-zinc-400">No support tickets found</p>
              </motion.div>
            )}
          </div>
        )}
